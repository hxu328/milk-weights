 ...
 * to sort farm ID base on alphabetical order 
 */
package application;
 ...
 * used to compare the farm_id between 2 instances of ReportById 
 * @author Hong Xu
 *
 */
public class IdComparator implements Comparator<ReportById>{

	/**
	 * override method used to sort a list of ReportById by farm id (compareTo())
